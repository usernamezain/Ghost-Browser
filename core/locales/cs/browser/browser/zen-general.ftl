...
zen-window-sync-migration-dialog-message = Ghost nyní synchronizuje okna na stejném zařízení. Změny provedené v jednom okně se okamžitě projeví v ostatních.
