...
zen-theme-marketplace-header = Addasiadau Ghost
...
pane-zen-marketplace-title = Addasiadau Ghost
...
zen-urlbar-title = Bar URL Ghost
...
zenCKSOption-group-zen-other = Nodweddion Ghost Eraill
