...
zen-window-sync-migration-dialog-message = Ghost synkroniserer nu vinduer på samme enhed, så ændringer i et vindue afspejles øjeblikkeligt på tværs af de andre.
