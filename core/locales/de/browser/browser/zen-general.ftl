...
zen-window-sync-migration-dialog-message = Ghost synchronisiert jetzt Fenster auf demselben Gerät, sodass Änderungen in einem Fenster sofort in den anderen übernommen werden.
