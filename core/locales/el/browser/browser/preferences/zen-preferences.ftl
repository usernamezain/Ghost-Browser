...
pane-zen-marketplace-title = Επεκτάσεις Ghost
...
zen-urlbar-title = Γραμμή Ghost URL
...
zenCKSOption-group-zen-other = Άλλες Λειτουργίες του Ghost
