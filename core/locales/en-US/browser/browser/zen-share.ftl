...
zen-share-overlay-add-space = Add Space to Ghost
zen-share-overlay-add-folder = Add Folder to Ghost
...
zen-share-confirm-description = Ghost uploads a copy of these tabs to the share server and copies a link anyone can open. The link expires after 30 days.
