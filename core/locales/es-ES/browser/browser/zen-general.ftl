...
zen-window-sync-migration-dialog-message = Ahora Ghost sincroniza las ventanas en el mismo dispositivo, por lo que los cambios en una ventana se reflejan en las demás instantáneamente.
