...
zen-theme-marketplace-header = Mods Ghost
...
pane-zen-marketplace-title = Mods Ghost
...
zen-urlbar-title = Barre d'adresse de Ghost
...
zenCKSOption-group-zen-other = Autres fonctionnalités de Ghost
