...
zen-theme-marketplace-header = Modhanna Ghost
...
pane-zen-marketplace-title = Modhanna Ghost
...
zen-urlbar-title = Barra URL Ghost
...
zenCKSOption-group-zen-other = Gnéithe Ghost Eile
