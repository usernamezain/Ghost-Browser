...
zen-theme-marketplace-header = שפצורים של Ghost
...
pane-zen-marketplace-title = שפצורים של Ghost
...
zen-urlbar-title = סרגל כתובת של Ghost
...
zenCKSOption-group-zen-other = תכונות אחרות של Ghost
