...
zen-theme-marketplace-header = Ghost modok
...
pane-zen-marketplace-title = Ghost modok
...
zen-urlbar-title = Ghost URL sáv
...
zenCKSOption-group-zen-other = Egyéb Ghost funkciók
