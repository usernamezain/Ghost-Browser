...
zen-theme-marketplace-header = Viðbrigðasnið Ghost
...
pane-zen-marketplace-title = Viðbrigðasnið Ghost
...
category-zen-marketplace = 
    .tooltiptext = Viðbrigðasnið Ghost
...
zenCKSOption-group-zen-other = Aðrir eiginleikar Ghost
