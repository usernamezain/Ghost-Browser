...
zen-window-sync-migration-dialog-message = Ghost samstillir núna glugga á sama tæki, þannig að breytingar í einum glugga endurspeglast samstundis í hinum.
