...
zen-theme-marketplace-header = Ghost Mod
...
pane-zen-marketplace-title = Ghost Mod
...
zen-urlbar-title = Barra degli indirizzi di Ghost
...
zenCKSOption-group-zen-other = Altre Caratteristiche Ghost
