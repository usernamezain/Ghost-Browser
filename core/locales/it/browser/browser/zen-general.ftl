...
zen-window-sync-migration-dialog-message = Ghost ora sincronizza le finestre sullo stesso dispositivo, quindi le modifiche in una finestra si riflettono istantaneamente sulle altre.
