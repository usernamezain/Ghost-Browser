...
zen-theme-marketplace-header = Ghost 모드
...
zen-theme-marketplace-input-default-placeholder = 
    .placeholder = 입력...
pane-zen-marketplace-title = Ghost 모드
...
zenCKSOption-group-zen-other = 다른 Ghost 기능들
