...
zen-window-sync-migration-dialog-message = Vanaf nu synchroniseert Ghost alle vensters op hetzelfde apparaat, dus aanpassingen in het ene venster worden tegelijkertijd op het andere venster toegepast.
