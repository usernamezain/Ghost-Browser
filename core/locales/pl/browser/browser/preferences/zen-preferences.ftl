...
zen-theme-marketplace-header = Modyfikacje Ghost
...
pane-zen-marketplace-title = Modyfikacje Ghost
...
zen-urlbar-title = Pasek adresu Ghost
...
zenCKSOption-group-zen-other = Inne funkcje Ghost
