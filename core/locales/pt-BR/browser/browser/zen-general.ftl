...
zen-window-sync-migration-dialog-message = Ghost agora sincroniza as janelas no mesmo dispositivo, assim as mudanças feitas em uma janela são refletidas para as outras instantaneamente.
