...
zen-theme-marketplace-header = Modificações do Ghost
...
pane-zen-marketplace-title = Modificações do Ghost
...
zen-urlbar-title = Barra de URL Ghost
...
category-zen-marketplace = 
    .tooltiptext = Modificações do Ghost
...
zenCKSOption-group-zen-other = Outras Funcionalidades do Ghost
