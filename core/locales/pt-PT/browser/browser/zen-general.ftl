...
zen-window-sync-migration-dialog-message = Agora, o Ghost sincroniza as janelas no dispositivo, pelo que alterações numa janela são refletidas instantaneamente nas outras.
