...
zen-theme-marketplace-header = Mod-uri Ghost
...
pane-zen-marketplace-title = Mod-uri Ghost
...
zen-urlbar-title = Bara URL Ghost
...
zenCKSOption-group-zen-other = Alte Funcții Ghost
