...
zen-theme-marketplace-header = Моды для Ghost
...
pane-zen-marketplace-title = Моды для Ghost
...
zen-urlbar-title = Поле адреса Ghost
...
zenCKSOption-group-zen-other = Другие функции Ghost
