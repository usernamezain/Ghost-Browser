...
zen-theme-marketplace-header = Ghost módy
...
pane-zen-marketplace-title = Ghost Módy
...
zen-urlbar-title = Ghost panel URL
...
zenCKSOption-group-zen-other = Ostatné funkcie Ghost
