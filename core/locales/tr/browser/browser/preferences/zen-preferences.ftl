...
zen-theme-marketplace-header = Ghost Modları
...
pane-zen-marketplace-title = Ghost Modları
...
zen-urlbar-title = Ghost URL Çubuğu
...
zenCKSOption-group-zen-other = Diğer Ghost Özellikleri
