...
zen-theme-marketplace-header = Ghost Моди
...
pane-zen-marketplace-title = Ghost Моди
...
zen-urlbar-title = Рядок URL-адрес Ghost
...
zenCKSOption-group-zen-other = Інші функції Ghost
