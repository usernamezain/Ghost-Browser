...
zen-theme-marketplace-header = Bản mod Ghost
...
zen-urlbar-title = Thanh địa chỉ Ghost
...
zenCKSOption-group-zen-other = Các tính năng khác của Ghost
