...
zen-theme-marketplace-header = Ghost 模组
...
zen-theme-marketplace-input-default-placeholder = 
    .placeholder = 输入点什么…
pane-zen-marketplace-title = Ghost 模组
...
zenCKSOption-group-zen-other = Ghost 的其它功能
