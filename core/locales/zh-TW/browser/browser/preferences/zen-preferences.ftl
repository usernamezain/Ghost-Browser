...
zen-theme-marketplace-header = Ghost 模組
...
zen-theme-marketplace-input-default-placeholder = 
    .placeholder = 請輸入...
pane-zen-marketplace-title = Ghost 模組
...
zenCKSOption-group-zen-other = 其它 Ghost 功能
